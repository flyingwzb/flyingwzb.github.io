...
创建一个字典并输出:
    ...
    NSMutableSet *set = [NSMutableSet setWithArray:@[@"set0",
                                                     strData,
                                                     dicData]];
    NSDictionary *dic = @{@"name"  : @"Will Wang",
                           @"My bolg" : @"https://flyingwzb.github.io",
                           @"count" : @(11),
                           @"strData" : strData,
                           @"dicData" : dicData,
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"Will Wang Blog:https://flyingwzb.github.io",
...
输出结果：
	...
	2017-03-01 10:36:45.709 BYFoundationLog_Demo[1657:53604] {
	    ...
	    contact =     (
	        "Will Wang Blog:https://flyingwzb.github.io",
	        "GitHub:https://github.com/qiubaiying",
